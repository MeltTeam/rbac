import type { CheckEnum, ResourceTypeEnum, SortOrderEnum } from '@packages/types'
...
export interface IResourceEntity {
  ...
  /** 访问地址(访问资源的URL,除了按钮类型) */
  path: string
  /** 路由参数(访问资源的URL后加的参数,除了按钮类型) */
  query: string
  /** 路由名称(菜单类型特有) */
  routeName: string
  /** 组件路径(菜单类型特有) */
  ...
  isVisible: CheckEnum
  /** 资源类型(10:菜单 20:按钮 30:接口 40:目录 默认:10) */
