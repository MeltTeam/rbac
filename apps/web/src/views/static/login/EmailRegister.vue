...
const rules = reactive<FormRules<IRegisterByEmailDto>>({
  username: [
...
<template>
  <AsyncMForm :ref="setInstance" validate-on-rule-change form-title="邮箱注册" :form-items="formItems" :rules="rules" :model="formData"></AsyncMForm>
</template>
