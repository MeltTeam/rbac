import type { IIdsDTO, IReplaceUsersRoleDTO } from '@packages/types'
...
export interface IUserRoleService {
  /** 批量给用户分配角色 */
  replaceUsersRoleByIds: (em: EntityManager, replaceUserRoleDTO: IReplaceUsersRoleDTO, by?: string) => Promise<IUserEntity[]>
  /** 获取多个用户ID的角色ID列表 */
